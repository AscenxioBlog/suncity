...
function Shop1() {
  return (
    ...
    <span className="text-transparent bg-clip-text bg-center bg-cover" style={{ WebkitTextStroke: "0.5px white" }}>O</span>
    <span className="text-transparent bg-clip-text bg-center bg-cover" style={{ WebkitTextStroke: "0.5px white" }}>P</span>
    <span className="text-transparent bg-clip-text bg-center bg-cover ml-4" style={{ WebkitTextStroke: "0.5px white" }}>P</span>
    <span className="text-transparent bg-clip-text bg-center bg-cover" style={{ WebkitTextStroke: "0.5px white" }}>A</span>
